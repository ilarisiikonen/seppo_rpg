...
export const LEVEL_ENEMIES: EnemyTemplate[][] = [
  /* Level 1 — Park */
  [
    { name: 'Angry Cyclist', portrait: 'assets/characters/angry_cyclist/rotations/west.png', anims: ANGRY_CYCLIST_ANIMS, lore: 'Someone cut him off. He\'s been like this since.', hp: 45, atk: 12, def: 4, xp: 18, loot: 0.25 },
    { name: 'Homeless Man',  portrait: 'assets/characters/homeles_man._1/rotations/west.png', anims: HOMELESS_MAN_1_ANIMS, lore: 'Territorial about his bench. And your wallet.', hp: 50, atk: 14, def: 3, xp: 22, loot: 0.25 },
  ],
  /* Level 2 — Street */
  [
    { name: 'Homeless Man',  portrait: 'assets/characters/homeless_man_2/rotations/west.png', anims: HOMELESS_MAN_2_ANIMS, lore: 'Back for round two. Angrier this time.', hp: 80, atk: 22, def: 8, xp: 38, loot: 0.35 },
    { name: '_BM_',          portrait: 'assets/characters/black_metal_musican/rotations/west.png', anims: BLACK_METAL_ANIMS, lore: 'Screams in a key that doesn\'t exist.', hp: 95, atk: 26, def: 9, xp: 48, loot: 0.35, randomName: true },
    { name: 'Bouncer',       portrait: 'assets/characters/bouncer/rotations/west.png', anims: BOUNCER_ANIMS, lore: 'Has never read a law. Compensates with mass.', hp: 110, atk: 28, def: 12, xp: 58, loot: 0.4 },
  ],
  /* Level 3 — Inside the Bar */
  [
    { name: 'Bouncer', portrait: 'assets/characters/bouncer/rotations/west.png', anims: BOUNCER_ANIMS, lore: 'The bar\'s last line of defence. Built like a fridge.', hp: 160, atk: 36, def: 16, xp: 85, loot: 0.45 },
  ],
]
