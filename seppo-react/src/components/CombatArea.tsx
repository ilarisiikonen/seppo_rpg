    ...
    <div className="relative z-10 w-full flex-1 flex items-end justify-around px-4 sm:px-16 max-w-5xl min-h-0">
      ...
      <div className="relative" id="player-sprite-box">
        ...
        <Sprite
          ...
          style={{ width: 'clamp(7rem, 28vh, 14rem)', height: 'clamp(7rem, 28vh, 14rem)' }}
        />
      ...
      {/* VS */}
      <div className="font-headline text-surface-container-highest text-4xl sm:text-8xl opacity-15 italic select-none self-center hidden sm:block">VS</div>

      {/* Enemy Sprite */}
      <div className="relative" id="enemy-sprite-box">
        <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-24 sm:w-44 h-5 sm:h-7 bg-black/40 blur-xl rounded-full" />
        {enemyAnims ? (
          <Sprite
            animSet={enemyAnims}
          ...
          <div className="text-4xl sm:text-8xl transition-transform duration-200 brightness-90 flex items-center justify-center" style={{ width: 'clamp(7rem, 28vh, 14rem)', height: 'clamp(7rem, 28vh, 14rem)' }}>❓</div>
        )}
