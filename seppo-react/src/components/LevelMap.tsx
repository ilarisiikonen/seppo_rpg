...
import { LEVEL_NAMES, LEVEL_BGS, LEVEL_ENEMIES, FOODS, getPlayerAtk, getPlayerDef, getCritChance, getFoodLabel } from '../gameData'

type MapNodeType = 'fight' | 'rest' | 'boss_first' | 'boss'
interface RouteNode { type: MapNodeType; done: boolean }
type LevelRoute = RouteNode[]

function levelBossType(lvIdx: number): 'boss_first' | 'boss' | null {
