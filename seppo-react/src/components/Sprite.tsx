...
export default function Sprite({ animSet, animKey, animSeq, onComplete, className = '', style }: SpriteProps) {
  ...
  if (!src) return null
  return <img src={src} alt="" className={`sprite-canvas ${className}`} style={style} />
}
